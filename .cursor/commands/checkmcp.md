...
| `v8std-mcp` | — | — (hosted HTTP, **not** docker) | v8std.ru standards navigation, BSLLS/ACC/EDT diagnostic bridge | No — public `https://ai.v8std.ru/mcp` |
